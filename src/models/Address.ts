...
const addressSchema = new Schema<IAddress>(
  {
    ...
    label: {
      ...
      trim: true,
      minlength: [2, "Address label must contain at least 2 characters."],
    ...
    street: {
      ...
      trim: true,
      minlength: [2, "Street must contain at least 2 characters."],
      maxlength: [180, "Street cannot exceed 180 characters."],
    },
    ...
    apartment: {
      type: String,
      trim: true,
      maxlength: [30, "Apartment cannot exceed 30 characters."],
      default: "",
    },
    ...
    landmark: {
      type: String,
      trim: true,
      maxlength: [180, "Landmark cannot exceed 180 characters."],
      default: "",
    },
    ...
    contactPhone: {
      ...
      match: [/^[+\d][\d\s()-]{5,29}$/, "Contact phone format is invalid."],
      default: undefined,
    },
...
const AddressModel =
  (mongoose.models.Address as Model<IAddress> | undefined) ??
