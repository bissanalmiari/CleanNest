  ...
  new Schema<IPayment>(
    {
      ...
      currency: {
        ...
        enum: {
          values: ["USD"],
          message:
            "CleanNest currently supports USD payments only.",
        },
        default: "USD",
        required: true,
      },
      ...
      failureReason: {
        ...
        maxlength: [
          500,
          "Payment failure reason cannot exceed 500 characters.",
        ],
        default: undefined,
      },
      ...
      refundReference: {
        ...
        maxlength: [
          150,
          "Refund reference cannot exceed 150 characters.",
        ],
        default: undefined,
      },
...
paymentSchema.pre(
  ...
  function validatePaymentProvider() {
    if (
      ...
      this.invalidate(
        "provider",
        "Cash payments must use the cash provider.",
      );
    }
  ...
  function validatePaymentStatus() {
    ...
    if (
      ...
      if (!this.paidAt) {
        this.invalidate(
          "paidAt",
          "A payment must be paid before it can be refunded.",
        );
      }
