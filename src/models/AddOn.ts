...
const addonSchema = new Schema(
  {
    name: {
      ...
      minlength: [
        2,
        "Add-on name must contain at least 2 characters.",
      ],
      maxlength: [
        100,
    ...
    description: {
      ...
      maxlength: [
        500,
        "Add-on description cannot exceed 500 characters.",
      ],
      default: "",
    },
...
export type Addon =
  InferSchemaType<typeof addonSchema>;

export type AddonDocument =
  HydratedDocument<Addon>;

const AddonModel =
  (models.Addon as
    | Model<Addon>
    | undefined) ??
  model<Addon>("Addon", addonSchema);
