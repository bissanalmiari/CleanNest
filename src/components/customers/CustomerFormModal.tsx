...
// Shared Add/Edit modal for a customer. When `customer` is null, it's in
// "Add" mode (email + password required). When `customer` is provided,
...
interface CustomerFormModalProps {
  open: boolean;
  customer: CustomerRow | null; // null => "Add" mode
  onClose: () => void;
