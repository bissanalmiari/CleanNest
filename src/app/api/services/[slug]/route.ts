...
export async function GET(_request: NextRequest, context: ServiceDetailsRouteContext) {
  try {
    ...
    if (normalizedSlug.length > 120) {
      return NextResponse.json(
        {
          success: false,
          message: "Service slug cannot exceed 120 characters.",
        },
        {
          status: 400,
        }
    ...
    return NextResponse.json(
      {
        success: false,
        message: "Unable to retrieve the service.",
