  ...
  return (
    <main className="min-h-[calc(100vh-76px)] bg-[#f3f7fc] px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-[1450px]">
        <div className="relative overflow-hidden rounded-[2rem] bg-navy p-8 text-white shadow-[0_24px_70px_rgba(11,37,69,0.2)]">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-2 font-heading text-xl font-black">Preparing your next page</p>
            </div>
